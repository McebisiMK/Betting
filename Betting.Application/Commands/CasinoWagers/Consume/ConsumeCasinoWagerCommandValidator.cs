...
{
    public class ConsumeCasinoWagerCommandValidator : AbstractValidator<ConsumeCasinoWagerCommand>
    {
        private readonly IRepository<Domain.CasinoWager> _casinoWagerRepository;

        public ConsumeCasinoWagerCommandValidator(IRepository<Domain.CasinoWager> casinoWagerRepository)
        {
